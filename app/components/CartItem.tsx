...
function CartItem() {
    return (
        <div className='grid grid-cols-12 mt-6'>
            <div className='col-span-9 bg-gray-100 p-4 rounded-lg shadow-xl h-64 '>
            ...
            <div className='col-span-3 bg-gray-100 p-4 rounded-lg shadow-xl h-64 '>
                <img className='w-full h-full object-contain rounded-lg hover:scale-150 transition-all duration-300 hover:shadow-xl cursor-pointer' src="https://images.squarespace-cdn.com/content/v1/5935fc072e69cf2cca7ff658/1684437574257-Y1NJGH6IU443D3BKL0YO/LE_Spring_2023-30.jpg?format=1000w" alt="" />
            </div>
        </div>
    )
}
